...
$page_title = 'My Workout Plans - ' . APP_NAME;
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li class="active"><a href="workouts.php"><i class="fas fa-dumbbell"></i> Workout Plans</a></li>
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="page-header">
                    <h1><i class="fas fa-dumbbell"></i> My Workout Plans <small>Your personalized exercise plans</small></h1>
                </div>
                ...
                <?php if (empty($workouts)): ?>
                    <div class="alert alert-info text-center py-5">
                        ...
                        <p class="mb-0">Once a trainer assigns you a plan, it will appear here.</p>
                    </div>
                <?php else: ?>
                    <div class="row">
                        <?php foreach ($workouts as $plan): ?>
                            ...
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        <p class="mb-1"><strong><i class="fas fa-user"></i> Trainer:</strong> <?php echo htmlspecialchars($plan['trainer_name'] ?: 'N/A'); ?></p>
                                        <p class="mb-1"><strong><i class="fas fa-calendar-week"></i> Duration:</strong> <?php echo $plan['duration_weeks'] ? $plan['duration_weeks'] . ' weeks' : 'Not specified'; ?></p>
                                        <p class="mb-1"><strong><i class="fas fa-calendar-alt"></i> Start:</strong> <?php echo $plan['start_date'] ? date('M d, Y', strtotime($plan['start_date'])) : 'N/A'; ?></p>
                                        <p class="mb-1"><strong><i class="fas fa-calendar-check"></i> End:</strong> <?php echo $plan['end_date'] ? date('M d, Y', strtotime($plan['end_date'])) : 'N/A'; ?></p>
                                        <p class="mb-2"><strong><i class="fas fa-list"></i> Exercises:</strong></p>
                                        <div class="small text-muted" style="max-height: 150px; overflow-y: auto;">
                                            <?php echo nl2br(htmlspecialchars($plan['exercises'] ?: 'No exercises listed.')); ?>
                                        </div>
                                    </div>
                                    <div class="card-footer d-flex justify-content-between align-items-center bg-light">
                                        <span class="badge badge-<?php echo $status_class; ?> px-3 py-2"><?php echo ucfirst($plan['status']); ?></span>
                                        <a href="view_workout.php?id=<?php echo $plan['id']; ?>" class="btn btn-outline-primary btn-sm">
